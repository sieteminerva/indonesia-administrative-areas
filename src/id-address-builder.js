import { IAddressAdapterBase } from "./id-address-adapter.base";
import { IAddressAdapterNative } from "./id-address-adapter.native";
...
export class IdAddressBuilder {
   ...
   */
  async _fetchAPI(query = {}, options = {}, timeout = 10000) {
 ...
 * @returns {boolean}
 */
export function _isIAddressDetail(obj) {
  if (typeof obj !== "object" || obj === null) return false;

  // ensure all keys are known
 ...
 *
 * @param {string} key - The property name to validate (e.g., 'propinsi_id', 'latitude').
